    ...
    <>
      <div className="h-screen w-screen items-center flex justify-center bg-gray-100 animate-fade-up">
        <div className="flex flex-row justify-center items-center h-[70%] w-[800px] relative">
          ...
          {/* Col Span 2 */}
          <div className="relative flex flex-col text-gray-700 bg-white shadow-lg rounded-r-xl bg-clip-border h-full justify-center">
            <div className="flex flex-col w-full items-center">
              ...
              />
              <p className="text-sm -mt-2">Register Your Account</p>
            </div>
